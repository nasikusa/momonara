...
<div class="fv_description_wrapper">
	...
	@if ( $random_num == 0  )
		<video src="/storage/app_videos/main1_2mbps_10sec_24fps.mp4" autoplay class="index_main_video" loop="true" data-object-fit="cover">
	@elseif ( $random_num == 1 )
		<video src="/storage/app_videos/main2_2mbps_10sec_24fps.mp4" autoplay class="index_main_video" loop="true" data-object-fit="cover">
	@elseif ( $random_num == 2 )
		<video src="/storage/app_videos/main3_2mbps_10sec_24fps.mp4" autoplay class="index_main_video" loop="true" data-object-fit="cover">
	@else
		<video src="/storage/app_videos/main4_2mbps_10sec_24fps.mp4" autoplay class="index_main_video" loop="true" data-object-fit="cover">
	@endif
	<!-- </div> -->
