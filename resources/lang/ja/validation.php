...
return [
    ...
    */
	...
	// added 20170207
	'cntrl'                => ':attributeには制御文字を使用しないでください',
	'cntrlnrt'             => ':attributeには制御文字を使用しないでください（改行文字とタブは使用可能です）',
	'fixedalpha'           => ':attributeには半角のアルファベットのみ使用可能です',
	'fixedalphanum'        => ':attributeには半角のアルファベットと数字のみ使用可能です',
